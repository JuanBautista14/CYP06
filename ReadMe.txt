...
AppWizard ha creado esta aplicación quisodecir.

Este archivo incluye un resumen acerca del contenido de los archivos que 
constituyen su aplicación quisodecir.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) denominado quisodecir.pch y un archivo de tipos 
