...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	while ((strcmp(szPalabraLeida, "fin"))!=0)
	{
		//pide una palabra
		printf("Escriba una palabra o digite 'fin' para terminar: ");
		scanf_s("%s", szPalabraLeida, TAMTOKEN-1);
		...
		// prueba de clana palabras QUITARRRRR
